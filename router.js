  ...
  render() {
    return (
      <Provider store={store}>
        <NavigationContainer>
          <Stack.Navigator>
            <Stack.Screen options={{headerShown: false}} name="Home" component={LoginComponent} />
            <Stack.Screen options={{headerShown:false}} name="Concept" component={Concept} />
            <Stack.Screen options={{headerShown:false}} name="List" component={ListComponent} />
            <Stack.Screen options={{headerShown:false}} name="Product" component={ProductDtail} />
            <Stack.Screen options={{headerShown:false}} name="Account" component={AccountComponent} />
          </Stack.Navigator>
        </NavigationContainer>
      </Provider>
    );
